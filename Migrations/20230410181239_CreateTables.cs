    ...
    public partial class CreateTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskContributor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskContributor_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskContributor_Task_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Task",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskContributor_TaskId",
                table: "TaskContributor",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskContributor_UserId",
                table: "TaskContributor",
                column: "UserId");
        }
